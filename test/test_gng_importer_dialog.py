...
__author__ = 'empty@emty.org'
__date__ = '2026-09-12'
__copyright__ = 'Copyright 2026, ZeFlyingGnome'
...
class GNGImporterDialogTest(unittest.TestCase):
    """Test dialog works."""

    def setUp(self):
        """Runs before each test."""
        self.dialog = GNGImporterDialog(None)
...
if __name__ == "__main__":
    suite = unittest.makeSuite(GNGImporterDialogTest)
