...
SOURCES = \
	__init__.py \
	gng_importer.py gng_importer_dialog.py

PLUGINNAME = gng_importer

PY_FILES = \
	__init__.py \
	gng_importer.py gng_importer_dialog.py

UI_FILES = gng_importer_dialog_base.ui
...
QGISDIR=C:\Users\micro\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
